...
namespace Skill_Point.异步多线程
{
    ...
    /// 4 Task初步接触
    /// </summary>
    public partial class 异步多线程演变 : Form
    {
        public 异步多线程演变()
        {
            Console.WriteLine("**********************异步多线程的进阶使用**********************");
            InitializeComponent();
        }
        #region btnSync_Click 同步方法
        /// <summary>
        /// 同步方法
        /// </summary>
        ...
        private void btnAsync_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                IAsyncResult Async = act.BeginInvoke(null, null);
                act.EndInvoke(Async);
        ...
        #region btnThread_Click 线程（线程1.0版本）
        /// <summary>
        /// Threads  线程（线程1.0版本）
        /// </summary>
        /// <param name="sender"></param>
        ...
        #region btnThreadPool_Click  线程池（线程2.0版本）
        /// <summary>
        /// 线程池（线程2.0版本）
        /// </summary>
        /// <param name="sender"></param>
        ...
        #region btnTask_Click  线程工厂（线程3.0版本）
        /// <summary>
        /// Task  线程工厂（线程3.0版本）
        /// </summary>
        /// <param name="sender"></param>
