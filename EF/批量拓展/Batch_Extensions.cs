...
namespace EF
{
    public class Batch_Extensions
    {
        ...
        public int Update()
        {
            ...
            {
                return db.User_info.Where(u => u.User_Name.EndsWith("张三")).
                    Update(u => new User_info
                    {
                        Remark = u.User_Name + "批量更新"
                    });
            }
        }
        ...
        public bool Insert()
        {
            ...
            for (int i = 0; i < 1000; i++)
			{
              ...
              user.UserID = "batch" + i.ToString();
              user.User_Name = "batch张三" + i.ToString() + "号";
              user.User_Pwd = "batch_Pwd" + i.ToString() + "号";
              user.User_Type = i;
              user.Remark = "batch_Remark" + i.ToString() + "号";
              infos.Add(user);
			}
